<div class="admin-section admin-section1">
    <ul>
        ...
        <li><i class="fas fa-film"></i><a href="addadmin.php">Add Admin</a> <i class="fas admin-dropdown fa-chevron-right"></i></a></li>
        <li><i class="fas fa-film"></i><a href="addmovie.php">Movies</a> <i class="fas admin-dropdown fa-chevron-right"></i></a></li>
        <li><i class="fas fa-film"></i><a href="comingmovie.php">Coming Movies</a> <i class="fas admin-dropdown fa-chevron-right"></i></a></li>
    </ul>
</div>
